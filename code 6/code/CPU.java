...
/**
 * The Simple Machine arch.sm213.machine.student.CPU.
 *
 * Simulate the execution of a single cycle of the Simple Machine SM213 arch.sm213.machine.student.CPU.
 */

public class CPU extends AbstractSM213CPU {
  
  /**
   * Create a new arch.sm213.machine.student.CPU.
   *
   * @param name   fully-qualified name of arch.sm213.machine.student.CPU implementation.
   * @param memory main memory used by arch.sm213.machine.student.CPU.
   */
  ...
  /**
   * Fetch Stage of arch.sm213.machine.student.CPU Cycle.
  ...
  /**
   * Execution Stage of arch.sm213.machine.student.CPU Cycle.
